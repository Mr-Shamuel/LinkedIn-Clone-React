...
const MainSide = () => {
    ...
    const [openPrivacyEdit, setopenPrivacyEdit] = useState(null);
    ...
    // handle Privacy 
    const handlePrivecy = (id) => {


        // navigate('/home')
        setopenPrivacyEdit(id)
                    ...
                    posts.map(post => {
                        ...
                        return (
                            <div className="newsfeedCon" key={id}>
                                {
                                    (openPrivacyEdit === id && privacyEdit) && <PrivacyModal handlePrivecy={handlePrivecy} id={id}></PrivacyModal>
