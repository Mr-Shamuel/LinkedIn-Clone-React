            ...
            <section>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form_group">
                        <label  >Email</label>
                        <input onBlur={handleEmail} type="email" id="email" name="email" required />
                        {email === '' && <p style={{ textAlign: 'left' }}>Please Enter   email </p>}
                    </div>

                    <div className="form_group">
                        <label  >Password (6 or more characters)</label>
                        <input onBlur={handlePassword} type="password" name="passord" id="password" required />
                        {!isPassWordValid() && <p>Password must be at least 6 characters and include at least one uppercase letter, one lowercase letter, and one number.</p>}
                    </div>
